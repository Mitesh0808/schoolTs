...
exports.logout = exports.disableFinance = exports.authUser = exports.deleteFinance = exports.updateFinance = exports.getFinance = exports.createFinance = exports.getAllFinance = void 0;
const http_status_codes_1 = require("http-status-codes");
const express_async_handler_1 = __importDefault(require("express-async-handler"));
const financeValidator_1 = require("../validation/financeValidator");
...
exports.getFinance = (0, express_async_handler_1.default)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const { id } = req.params;
    ...
    try {
        const finance = yield model_1.Finance.findById(id);
        res.status(http_status_codes_1.StatusCodes.OK).send(finance);
    }
    catch (error) {
        res
            .status(http_status_codes_1.StatusCodes.BAD_REQUEST)
...
exports.authUser = (0, express_async_handler_1.default)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const finance = yield model_1.Finance.findOne({ email });
    if (!finance) {
        res.status(401).send("Invalid email or password");
        return;
    }
    const isMatch = yield (0, checkPassword_1.comparePassword)(password, finance.password);
    if (isMatch) {
